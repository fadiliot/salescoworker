...
import { ArrowRight, Mail, Lock, User, Briefcase, Bot } from 'lucide-react'
      ...
      <div className="hidden md:flex md:w-[45%] lg:w-[50%] p-12 flex-col justify-between relative overflow-hidden border-r border-slate-800 bg-slate-900/50 backdrop-blur-sm z-10">
        <div>
           <div className="flex items-center gap-3 text-white mb-16">
             <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#D4AF37] to-[#B8963E] flex items-center justify-center shadow-[0_0_20px_rgba(212,175,55,0.3)] text-slate-950">
               <Bot className="w-6 h-6" />
             </div>
             <span className="text-xl font-bold tracking-tight">Sales Co-worker</span>
           </div>
           <h1 className="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6 mt-16 font-serif">
             Scale your pipeline with <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#F3E5AB] via-[#D4AF37] to-[#B8963E]">Intelligent Automation</span>.
           </h1>
          ...
          {[
            ...
            { title: 'Intelligent Inbox', desc: 'Gemini drafts replies instantly.' }
             ...
             <div key={i} className="bg-slate-950/50 border border-slate-800 rounded-xl p-4">
               <div className="w-8 h-8 rounded-full bg-[#D4AF37]/10 flex items-center justify-center mb-3 border border-[#D4AF37]/20">
        ...
        <div className="text-sm text-slate-500 mt-20">
           © 2026 Sales Co-worker AI. Dubai Standard.
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 z-10 relative">
        <div className="w-full max-w-md">
          <div className="md:hidden flex items-center gap-3 text-white mb-10 justify-center">
             <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#D4AF37] to-[#B8963E] flex items-center justify-center text-slate-950">
               <Bot className="w-6 h-6" />
             </div>
             <span className="text-xl font-bold tracking-tight">Sales Co-worker</span>
          </div>
          ...
          <Card className="bg-slate-900 border-slate-800 shadow-2xl relative overflow-hidden backdrop-blur-xl">
            ...
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input required type="text" placeholder="John Doe" 
                        ...
                        className="w-full bg-slate-950 border border-slate-800 rounded-lg pl-10 pr-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#D4AF37]/50 focus:ring-1 focus:ring-[#D4AF37]/50 transition-all placeholder:text-slate-600" />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                ...
                <Button type="submit" disabled={loading} className="w-full mt-4 bg-gradient-to-r from-[#D4AF37] to-[#B8963E] text-slate-950 hover:opacity-90 font-bold py-5 mt-6 shadow-[0_0_20px_rgba(212,175,55,0.2)]">
                ...
                <p className="text-center text-xs text-slate-500 mt-6 leading-relaxed">
                  By clicking sign up, you agree to our <a href="#" className="text-[#D4AF37] hover:underline">Terms of Service</a> and <a href="#" className="text-[#D4AF37] hover:underline">Privacy Policy</a>.
                </p>
              </form>
            </CardContent>
          </Card>
          ...
          <p className="text-center text-sm text-slate-400 mt-8">
            Already have an account? <a href="/login" className="text-white hover:text-[#D4AF37] font-semibold transition-colors">Sign in here</a>
          </p>
        </div>
      </div>
    </div>
